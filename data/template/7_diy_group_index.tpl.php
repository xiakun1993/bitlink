...
block_get('16,18,2');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">
...
</div><?php echo adshow("text/wp a_t");?><style id="diy_style" type="text/css">#portal_block_2 .dxb_bc {  font-size:14px !important;margin-left:10px !important;}#portal_block_16 {  margin-top:7px !important;margin-right:5px !important;margin-bottom:7px !important;margin-left:5px !important;}#portal_block_16 .dxb_bc {  font-size:16px !important;}#portal_block_18 {  margin-top:7px !important;margin-right:5px !important;margin-bottom:7px !important;margin-left:5px !important;}#portal_block_18 .dxb_bc {  font-size:16px !important;}</style>
<div class="wp">
...
<!--[diy=diy5]--><div id="diy5" class="area"><div id="framek6wveP" class="frame move-span cl frame-1-1"><div id="framek6wveP_left" class="column frame-1-1-l"><div id="framek6wveP_left_temp" class="move-span temp"></div><?php block_display('16');?></div><div id="framek6wveP_center" class="column frame-1-1-r"><div id="framek6wveP_center_temp" class="move-span temp"></div><?php block_display('18');?><?php block_display('2');?></div></div></div><!--[/diy]-->
</div>

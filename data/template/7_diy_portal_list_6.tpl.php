...
0
|| checktplrefresh('data/diy/./template/default//portal/list_6.htm', './template/default/common/header.htm', 1430379384, 'diy', './data/template/7_diy_portal_list_6.tpl.php', 'data/diy/./template/default/', 'portal/list_6')
|| checktplrefresh('data/diy/./template/default//portal/list_6.htm', './template/default/common/footer.htm', 1430379384, 'diy', './data/template/7_diy_portal_list_6.tpl.php', 'data/diy/./template/default/', 'portal/list_6')
|| checktplrefresh('data/diy/./template/default//portal/list_6.htm', './template/default/common/header_common.htm', 1430379384, 'diy', './data/template/7_diy_portal_list_6.tpl.php', 'data/diy/./template/default/', 'portal/list_6')
|| checktplrefresh('data/diy/./template/default//portal/list_6.htm', './template/default/common/header_qmenu.htm', 1430379384, 'diy', './data/template/7_diy_portal_list_6.tpl.php', 'data/diy/./template/default/', 'portal/list_6')
|| checktplrefresh('data/diy/./template/default//portal/list_6.htm', './template/default/common/pubsearchform.htm', 1430379384, 'diy', './data/template/7_diy_portal_list_6.tpl.php', 'data/diy/./template/default/', 'portal/list_6')
;
block_get('35');?>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="framehL4k1D" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="framehL4k1D_left" class="column frame-1-c"><div id="framehL4k1D_left_temp" class="move-span temp"></div><?php block_display('35');?></div></div></div><!--[/diy]-->
</div>	</div>

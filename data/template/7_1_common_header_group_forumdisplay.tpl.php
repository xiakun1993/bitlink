...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1431961555, '1', './data/template/7_1_common_header_group_forumdisplay.tpl.php', './template/default', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1431961555, '1', './data/template/7_1_common_header_group_forumdisplay.tpl.php', './template/default', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1431961555, '1', './data/template/7_1_common_header_group_forumdisplay.tpl.php', './template/default', 'common/header_group_forumdisplay')
;?>

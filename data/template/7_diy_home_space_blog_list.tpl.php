...
0
|| checktplrefresh('data/diy/./template/default//home/space_blog_list.htm', './template/default/home/space_header.htm', 1431836718, 'diy', './data/template/7_diy_home_space_blog_list.tpl.php', 'data/diy/./template/default/', 'home/space_blog_list')
|| checktplrefresh('data/diy/./template/default//home/space_blog_list.htm', './template/default/common/userabout.htm', 1431836718, 'diy', './data/template/7_diy_home_space_blog_list.tpl.php', 'data/diy/./template/default/', 'home/space_blog_list')
|| checktplrefresh('data/diy/./template/default//home/space_blog_list.htm', './template/default/home/space_userabout.htm', 1431836718, 'diy', './data/template/7_diy_home_space_blog_list.tpl.php', 'data/diy/./template/default/', 'home/space_blog_list')
|| checktplrefresh('data/diy/./template/default//home/space_blog_list.htm', './template/default/common/header_common.htm', 1431836718, 'diy', './data/template/7_diy_home_space_blog_list.tpl.php', 'data/diy/./template/default/', 'home/space_blog_list')
|| checktplrefresh('data/diy/./template/default//home/space_blog_list.htm', './template/default/home/space_diy.htm', 1431836718, 'diy', './data/template/7_diy_home_space_blog_list.tpl.php', 'data/diy/./template/default/', 'home/space_blog_list')
|| checktplrefresh('data/diy/./template/default//home/space_blog_list.htm', './template/default/home/space_header_personalnv.htm', 1431836718, 'diy', './data/template/7_diy_home_space_blog_list.tpl.php', 'data/diy/./template/default/', 'home/space_blog_list')
;
block_get('20,20,20');?>
...
<div class="mn">
<!--[diy=diycontenttop]--><div id="diycontenttop" class="area"><div id="frameUD1IKm" class="frame move-span cl frame-1"><div id="frameUD1IKm_left" class="column frame-1-c"><div id="frameUD1IKm_left_temp" class="move-span temp"></div><?php block_display('20');?></div></div></div><!--[/diy]-->
<div class="bm bw0">
<div class="bm_c">
<?php } } else { include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">

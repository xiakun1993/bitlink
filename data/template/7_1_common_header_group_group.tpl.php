...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1431792301, '1', './data/template/7_1_common_header_group_group.tpl.php', './template/default', 'common/header_group_group')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1431792301, '1', './data/template/7_1_common_header_group_group.tpl.php', './template/default', 'common/header_group_group')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1431792301, '1', './data/template/7_1_common_header_group_group.tpl.php', './template/default', 'common/header_group_group')
;?>

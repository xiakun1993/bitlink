...
0
|| checktplrefresh('data/diy/./template/default//portal/list_5.htm', './template/default/common/header.htm', 1430379206, 'diy', './data/template/7_diy_portal_list_5.tpl.php', 'data/diy/./template/default/', 'portal/list_5')
|| checktplrefresh('data/diy/./template/default//portal/list_5.htm', './template/default/common/footer.htm', 1430379206, 'diy', './data/template/7_diy_portal_list_5.tpl.php', 'data/diy/./template/default/', 'portal/list_5')
|| checktplrefresh('data/diy/./template/default//portal/list_5.htm', './template/default/common/header_common.htm', 1430379206, 'diy', './data/template/7_diy_portal_list_5.tpl.php', 'data/diy/./template/default/', 'portal/list_5')
|| checktplrefresh('data/diy/./template/default//portal/list_5.htm', './template/default/common/header_qmenu.htm', 1430379206, 'diy', './data/template/7_diy_portal_list_5.tpl.php', 'data/diy/./template/default/', 'portal/list_5')
|| checktplrefresh('data/diy/./template/default//portal/list_5.htm', './template/default/common/pubsearchform.htm', 1430379206, 'diy', './data/template/7_diy_portal_list_5.tpl.php', 'data/diy/./template/default/', 'portal/list_5')
;
block_get('34');?>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameZL2436" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frameZL2436_left" class="column frame-1-c"><div id="frameZL2436_left_temp" class="move-span temp"></div><?php block_display('34');?></div></div></div><!--[/diy]-->
</div>	</div>

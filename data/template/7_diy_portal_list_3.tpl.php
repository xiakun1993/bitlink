...
0
|| checktplrefresh('data/diy/./template/default//portal/list_3.htm', './template/default/common/header.htm', 1430378416, 'diy', './data/template/7_diy_portal_list_3.tpl.php', 'data/diy/./template/default/', 'portal/list_3')
|| checktplrefresh('data/diy/./template/default//portal/list_3.htm', './template/default/common/footer.htm', 1430378416, 'diy', './data/template/7_diy_portal_list_3.tpl.php', 'data/diy/./template/default/', 'portal/list_3')
|| checktplrefresh('data/diy/./template/default//portal/list_3.htm', './template/default/common/header_common.htm', 1430378416, 'diy', './data/template/7_diy_portal_list_3.tpl.php', 'data/diy/./template/default/', 'portal/list_3')
|| checktplrefresh('data/diy/./template/default//portal/list_3.htm', './template/default/common/header_qmenu.htm', 1430378416, 'diy', './data/template/7_diy_portal_list_3.tpl.php', 'data/diy/./template/default/', 'portal/list_3')
|| checktplrefresh('data/diy/./template/default//portal/list_3.htm', './template/default/common/pubsearchform.htm', 1430378416, 'diy', './data/template/7_diy_portal_list_3.tpl.php', 'data/diy/./template/default/', 'portal/list_3')
;
block_get('32');?>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frame6e2Kh1" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frame6e2Kh1_left" class="column frame-1-c"><div id="frame6e2Kh1_left_temp" class="move-span temp"></div><?php block_display('32');?></div></div></div><!--[/diy]-->
</div>	</div>

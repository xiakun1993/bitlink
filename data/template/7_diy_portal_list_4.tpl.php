...
0
|| checktplrefresh('data/diy/./template/default//portal/list_4.htm', './template/default/common/header.htm', 1430378654, 'diy', './data/template/7_diy_portal_list_4.tpl.php', 'data/diy/./template/default/', 'portal/list_4')
|| checktplrefresh('data/diy/./template/default//portal/list_4.htm', './template/default/common/footer.htm', 1430378654, 'diy', './data/template/7_diy_portal_list_4.tpl.php', 'data/diy/./template/default/', 'portal/list_4')
|| checktplrefresh('data/diy/./template/default//portal/list_4.htm', './template/default/common/header_common.htm', 1430378654, 'diy', './data/template/7_diy_portal_list_4.tpl.php', 'data/diy/./template/default/', 'portal/list_4')
|| checktplrefresh('data/diy/./template/default//portal/list_4.htm', './template/default/common/header_qmenu.htm', 1430378654, 'diy', './data/template/7_diy_portal_list_4.tpl.php', 'data/diy/./template/default/', 'portal/list_4')
|| checktplrefresh('data/diy/./template/default//portal/list_4.htm', './template/default/common/pubsearchform.htm', 1430378654, 'diy', './data/template/7_diy_portal_list_4.tpl.php', 'data/diy/./template/default/', 'portal/list_4')
;
block_get('33');?>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameeU33b3" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frameeU33b3_left" class="column frame-1-c"><div id="frameeU33b3_left_temp" class="move-span temp"></div><?php block_display('33');?></div></div></div><!--[/diy]-->
</div>	</div>

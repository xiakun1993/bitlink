<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_9');
0
|| checktplrefresh('data/diy/./template/default//portal/list_9.htm', './template/default/common/header.htm', 1431791645, 'diy', './data/template/7_diy_portal_list_9.tpl.php', 'data/diy/./template/default/', 'portal/list_9')
|| checktplrefresh('data/diy/./template/default//portal/list_9.htm', './template/default/common/footer.htm', 1431791645, 'diy', './data/template/7_diy_portal_list_9.tpl.php', 'data/diy/./template/default/', 'portal/list_9')
|| checktplrefresh('data/diy/./template/default//portal/list_9.htm', './template/default/common/header_common.htm', 1431791645, 'diy', './data/template/7_diy_portal_list_9.tpl.php', 'data/diy/./template/default/', 'portal/list_9')
|| checktplrefresh('data/diy/./template/default//portal/list_9.htm', './template/default/common/header_qmenu.htm', 1431791645, 'diy', './data/template/7_diy_portal_list_9.tpl.php', 'data/diy/./template/default/', 'portal/list_9')
|| checktplrefresh('data/diy/./template/default//portal/list_9.htm', './template/default/common/pubsearchform.htm', 1431791645, 'diy', './data/template/7_diy_portal_list_9.tpl.php', 'data/diy/./template/default/', 'portal/list_9')
;
block_get('38');?>
...
<!--[diy=diy1]--><div id="diy1" class="area"><div id="frameRpzlOZ" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">照片墙</span></div><div id="frameRpzlOZ_left" class="column frame-1-c"><div id="frameRpzlOZ_left_temp" class="move-span temp"></div><?php block_display('38');?></div></div></div><!--[/diy]-->
</div>	</div>

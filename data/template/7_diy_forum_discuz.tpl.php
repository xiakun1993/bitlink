...
block_get('21,14,15');?><?php include template('common/header'); ?><div id="pt" class="bm cl">
...
<?php } ?>
<!--[diy=diy_chart]--><div id="diy_chart" class="area"><div id="frame61vnR9" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frame61vnR9_left" class="column frame-1-c"><div id="frame61vnR9_left_temp" class="move-span temp"></div><?php block_display('21');?></div></div></div><!--[/diy]-->
<div class="mn">
...
<div class="drag">
<!--[diy=diy2]--><div id="diy2" class="area"><div id="frameSiohzC" class="frame move-span cl frame-1"><div class="title frame-title" style='background-image:none;background-repeat:repeat;background-color:rgb(153, 0, 204);'><span class="titletext" style="font-size:20px;color:rgb(255, 255, 255);">网站信息</span></div><div id="frameSiohzC_left" class="column frame-1-c"><div id="frameSiohzC_left_temp" class="move-span temp"></div><?php block_display('14');?><?php block_display('15');?></div></div></div><!--[/diy]-->
</div>

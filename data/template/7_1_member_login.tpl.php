...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1430378424, '1', './data/template/7_1_member_login.tpl.php', './template/default', 'member/login')

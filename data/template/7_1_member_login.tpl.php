...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1431836715, '1', './data/template/7_1_member_login.tpl.php', './template/default', 'member/login')

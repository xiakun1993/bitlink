...
0
|| checktplrefresh('data/diy/./template/default//home/space_album_list.htm', './template/default/home/space_header.htm', 1431836720, 'diy', './data/template/7_diy_home_space_album_list.tpl.php', 'data/diy/./template/default/', 'home/space_album_list')
|| checktplrefresh('data/diy/./template/default//home/space_album_list.htm', './template/default/common/userabout.htm', 1431836720, 'diy', './data/template/7_diy_home_space_album_list.tpl.php', 'data/diy/./template/default/', 'home/space_album_list')
|| checktplrefresh('data/diy/./template/default//home/space_album_list.htm', './template/default/home/space_userabout.htm', 1431836720, 'diy', './data/template/7_diy_home_space_album_list.tpl.php', 'data/diy/./template/default/', 'home/space_album_list')
|| checktplrefresh('data/diy/./template/default//home/space_album_list.htm', './template/default/common/header_common.htm', 1431836720, 'diy', './data/template/7_diy_home_space_album_list.tpl.php', 'data/diy/./template/default/', 'home/space_album_list')
|| checktplrefresh('data/diy/./template/default//home/space_album_list.htm', './template/default/home/space_diy.htm', 1431836720, 'diy', './data/template/7_diy_home_space_album_list.tpl.php', 'data/diy/./template/default/', 'home/space_album_list')
|| checktplrefresh('data/diy/./template/default//home/space_album_list.htm', './template/default/home/space_header_personalnv.htm', 1431836720, 'diy', './data/template/7_diy_home_space_album_list.tpl.php', 'data/diy/./template/default/', 'home/space_album_list')
;
block_get('19,19,19');?>
...
<style id="diy_style" type="text/css">#portal_block_19 {  margin-top:7px !important;margin-right:5px !important;margin-bottom:7px !important;margin-left:5px !important;}#portal_block_19 .dxb_bc {  font-size:16px !important;}</style>
<div class="wp">
<!--[diy=diy1]--><div id="diy1" class="area"></div><!--[/diy]-->
</div><?php include template('home/space_menu'); ?><div id="ct" class="ct1 wp cl">
<div class="mn">
<!--[diy=diycontenttop]--><div id="diycontenttop" class="area"><div id="frameo2rp4x" class="frame move-span cl frame-1"><div id="frameo2rp4x_left" class="column frame-1-c"><div id="frameo2rp4x_left_temp" class="move-span temp"></div><?php block_display('19');?></div></div></div><!--[/diy]-->
<div class="bm bw0">
<div class="bm_c">
<?php } } else { include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">

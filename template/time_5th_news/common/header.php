...
<div class="topbar">
  <div class="topwrap">
    <div class="z"><a href="#" style="margin-left: -8px;">Home</a> <a href="#">官方微博</a> <a href="#">关于我们</a></div>
    <!-- 用户信息 -->
    <div class="userbox"> 
      <!--{if $_G['uid']}-->
      ...
      <ul class="usernav user_part">
        ...
        <li class="user_list"><a href="member.php?mod={$_G[setting][regname]}" class="user_link" style="padding: 0 2px 0 8px;">注册</a></li>
      </ul>

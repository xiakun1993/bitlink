  ...
  <div class="wpn pos cl">
    ...
    <div class="ft-list y">
      ...
      <p class="ft-copyright" style="color: #CECECE; text-align: right;">
         ...
         Powered by <a href="http://www.discuz.net" target="_blank" style="color: #CECECE;">Discuz!</a> <em style="color: #CECECE;">$_G['setting']['version']. </em>
         <!--{if $_G['setting']['icp']}--> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: #CECECE;">$_G['setting']['icp']</a> <!--{/if}-->
      </p>
      <div class="ft-shares">
         <a target="_blank" style="margin-top:4px; width:84px;" href="#"><img alt="安全联盟认证" style="border: medium none;" src="template/time_5th_news/src/hy_83x30.png" width="83" height="30" /></a>
         <a class="shares-brand shares-ucloud" title="ucloud" href="#" target="_blank"></a>
         <a class="shares iconfont pos shares-sina" title="新浪微博" href="#" target="_blank"></a>

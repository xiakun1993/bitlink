  ...
  <div class="z">
    ...
    <div class="y">
      ...
      <!--{hook/global_usernav_extra3}-->
		...
		<a href="javascript:;" id="wqmenu" class="showmenu" onMouseOver="showMenu({'ctrlid':'wqmenu','pos':'34!','ctrlclass':'a','duration':2});">导航<span class="arrow"></span></a>
...
<div class="z"><!--{hook/global_login_extra}--></div>
	  ...
	  <a id="wist" href="javascript:;" onMouseOver="showMenu({'ctrlid':'wist','pos':'34!','ctrlclass':'a','duration':2});" title="{lang changestyle}" >切换</a><span class="wi_tpipe"></span>
